...
public class JobLauncherDetails extends QuartzJobBean {
	...
	static final String WRAPPER_NAME = "Wrapper";
	static final String CURSOR_NAME = "cursor";
	static final String ENGINEJOB_NAME = "locationEngineJob";
	static final String ENGINEJOBWRAPPER_NAME = "locationEngineJobWrapper";
	static final String ENGINESTEP_NAME = "workingStep";
	...
	protected void executeInternal(JobExecutionContext context) {
		...
		try {
			...
			log.debug("JobExecutionException: " + e);
		}
	}
