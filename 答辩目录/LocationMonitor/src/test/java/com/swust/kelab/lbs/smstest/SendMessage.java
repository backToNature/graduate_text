package com.swust.kelab.lbs.smstest;
...
public class SendMessage {
	...
	public void doIt() throws Exception {
		...
		SerialModemGateway gateway = new SerialModemGateway("modem.com1",
				"ttyUSB0", 115200, "Siemens", "");
		gateway.setInbound(false); // 设置false，表示该网关不可以接收短信,根据需求修改
		gateway.setOutbound(true);// 设置true，表示该网关可以发送短信,根据需求修改
		gateway.setSimPin("0000");// sim卡锁，一般默认为0000或1234
		// Explicit SMSC address set is required for some modems.
		// Below is for VODAFONE GREECE - be sure to set your own!
		gateway.setSmscNumber("+8613800816500");// 短信服务中心号码
		...
		OutboundMessage msg = new OutboundMessage("13990102434",
